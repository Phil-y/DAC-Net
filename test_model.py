...
if __name__ == '__main__':
    ...
    with tqdm(total=test_num, desc='Test visualize', unit='img', ncols=70, leave=True) as pbar:
        for i, (sampled_batch, names) in enumerate(test_loader, 1):
            ...
            print("Test Result:")
            print(
                'precision: %.4f, recall_Sensitivity: %.4f, specificity: %.4f, accuracy: %.4f, iou: %.4f, dice: %.4f, mae: %.4f, auc: %.4f, f1_score: %.4f'
                % (metrics_result['precision'], metrics_result['Sensitivity'], metrics_result['specificity'],
                   metrics_result['accuracy'], metrics_result['IOUJaccard'], metrics_result['dice_or_f1'],
                     metrics_result['MAEMAEMAE'], metrics_result['auc_roc'], metrics_result['f1_score'],)
                  )
            ...
            metrics_result['inference_time'] = total_cost_time
            keys_txt = ''
            values_txt = ''
